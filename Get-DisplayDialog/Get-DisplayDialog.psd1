...
@{
	...
	Description = 'A module providing a PowerShell interface to the AppleScript "Display Dialog" UI Primitive'
	...
	PrivateData = @{
		...
		PSData = @{
			...
			Tags = @("macOS","Mac","display dialog","AppleScript","AppleScript Bridge")
